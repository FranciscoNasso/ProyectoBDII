...
@Repository
public interface IPrediccion extends CrudRepository<Prediccion, String> {
    ...
    @Query(value = "SELECT id_participante, SUM(puntos) FROM Prediccion GROUP BY id_participante", nativeQuery = true)
